...
Die zwei Paare von zugeordneten Profilen mit Konfigurationsvariablen ohne Maßeinheiten weder in der Tabelle \texttt{co6\_config\_variables} noch im Frontend von \ac{copra} (\ref{tab:nounitscopra}) werden in diesem Projekt nicht weiter betrachtet.
