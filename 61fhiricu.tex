...
Die \ref{tab:proficu} zeigt die Anzahl an Profilen je Kategorie in dem Modul \glqq\ac{icu}\grqq{}. Die meist repräsentierten \ac{fhir}-Profile, nämlich 76, gehören zu der Kategorie \glqq Observation\grqq{}.

\begin{table}[ht]
	\centering 
	\caption[\acs{fhir}-Profile in dem Modul \glqq\acs{icu}\grqq{}]{\acs{fhir}-Profile in dem Modul \glqq\acs{icu}\grqq{}.}
	\label{tab:proficu}
	\begin{tabular}{|l|l|}
		\hline
