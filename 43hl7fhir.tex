...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item ?!: Das sind modifizierende Elemente, z.B. das Element \texttt{status} beschreibt den Zustand einer \glqq Procedure\grqq{}-Ressource, nämlich \texttt{final}, wenn die Ressource ein eine Endversion sich befindet (\ref{fig:logic-table}).
	\end{itemize}
