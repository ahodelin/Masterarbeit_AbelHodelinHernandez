...
Die Voraussetzungen für die Auswahl der Konfigurationsvariablen für die weitere Durchführung des Projekts werden definiert, nämlich patienten- oder fallbezogene Variablen, mit mindesten 1000 validierten, aktuellen und nicht gelöschten Datensätzen im den Werttabellen (\ref{subsec:datadef}).
